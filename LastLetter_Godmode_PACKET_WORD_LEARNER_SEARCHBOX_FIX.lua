...
local function GetGameTextBox()
    ...
    local focused = UserInputService:GetFocusedTextBox()
    -- Never treat WordHelper's own UI fields as Last Letter's gameplay input.
    ...
    local success, err = pcall(function()
        if isCorrection then
            ...
            if not accepted then
                ...
                local focused = UserInputService:GetFocusedTextBox()
                if focused and ScreenGui and focused:IsDescendantOf(ScreenGui) then
                    -- User is typing in WordHelper itself; never erase the helper field.
...
runConn = RunService.RenderStepped:Connect(function()
    local success, err = pcall(function()
        ...
        if autoPlay and not isTyping and not isAutoPlayScheduled and currentBestMatch and detected == lastDetected
            and not (UserInputService:GetFocusedTextBox() and ScreenGui and UserInputService:GetFocusedTextBox():IsDescendantOf(ScreenGui)) then
