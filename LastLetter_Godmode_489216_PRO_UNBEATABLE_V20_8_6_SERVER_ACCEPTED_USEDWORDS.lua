...
local function DisconnectUsedWordEventConnections()
...
local function CaptureUsedWordMutation(frame)
...
local function AttachUsedWordEventCapture(frame)
    ...
    DisconnectUsedWordEventConnections()
    ...
    table.insert(env.WordHelperUsedTracker.EventConnections,
        currentWord.ChildAdded:Connect(function() CaptureUsedWordMutation(frame) end))
    table.insert(env.WordHelperUsedTracker.EventConnections,
        currentWord.ChildRemoved:Connect(function() CaptureUsedWordMutation(frame) end))
end
...
runConn = RunService.RenderStepped:Connect(function()
    local success, err = pcall(function()
        ...
        AttachUsedWordEventCapture(frame)
