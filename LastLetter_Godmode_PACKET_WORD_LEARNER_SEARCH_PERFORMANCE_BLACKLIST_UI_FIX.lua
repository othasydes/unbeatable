...
env.WordHelperBlacklistTracker.Add = function(word, reason)
    ...
    -- Automatic rejection learning should always make the newly learned word
    -- immediately visible in the Rejected Words manager. An old manager search
    -- filter could otherwise hide a successfully saved blacklist entry.
    if reason ~= "manual confirmation"
        and env.WordHelperBlacklistSearch
        and env.WordHelperBlacklistSearch.Text ~= "" then
