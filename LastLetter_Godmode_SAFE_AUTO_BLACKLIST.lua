...
env.WordHelperBlacklistTracker.BeginAttempt = function(word)
    ...
    -- Snapshot any rejection labels already visible BEFORE this submission.
    -- Old/stale messages cannot blacklist the next word.
    ...
    task.spawn(function()
        ...
        while not unloaded
            ...
            -- Strong rejection proof: the game displayed a NEW invalid-word signal.
        ...
        -- IMPORTANT: no timeout/same-turn guess here.
        -- If the game did not explicitly reject the known dictionary word,
        -- leave it alone rather than risk poisoning the permanent blacklist.
...
env.WordHelperBlacklistTracker.KeyConnection =
    UserInputService.InputBegan:Connect(function(input, processed)
        ...
        -- Never learn from WordHelper search boxes, chat, or any other TextBox.
