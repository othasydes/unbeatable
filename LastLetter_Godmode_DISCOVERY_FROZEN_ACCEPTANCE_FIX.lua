...
env.WordHelperDiscovery.ObserveFrame = function(detectedWord, censored, typeText, now, frame)
    ...
    elseif typeText ~= env.WordHelperDiscovery.LastTypeText then
        ...
        local candidate = tostring(env.WordHelperDiscovery.AcceptanceCandidate or "")
        local candidateAt = tonumber(env.WordHelperDiscovery.AcceptanceCandidateAt or 0) or 0
        ...
        if pulseAt > 0
            ...
            and env.WordHelperDiscovery.AcceptanceCandidateValid == true then
