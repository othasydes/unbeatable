...
local blacklistSoundService = game:GetService("SoundService")
local blacklistGameSounds = blacklistSoundService:FindFirstChild("Game")
local blacklistWrongSound =
    blacklistGameSounds and blacklistGameSounds:FindFirstChild("Wrong")
...
if blacklistWrongSound and blacklistWrongSound:IsA("Sound") then
    env.WordHelperBlacklistTracker.WrongSoundConnection =
        blacklistWrongSound.Played:Connect(function()
            if unloaded then return end
