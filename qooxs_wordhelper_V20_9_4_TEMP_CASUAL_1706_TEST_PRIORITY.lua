-- V20.9.4 TEMP TEST: inject 1,706 Pro-recovered alphabetic words into Casual + absolute Godmode TEST priority
-- V20.8.38: manual blacklist restored + Pro turn-change lag smoothing
-- V20.9.3 OFFICIAL: Pro Spicy avoids repeating returned prefixes within a match
-- V20.9.2 OFFICIAL: live typing-progress highlight + all returned-prefix highlights
-- V20.9.1 OFFICIAL: qoox's wordhelper hacker UI + return-prefix tag highlight
-- V20.9.0: qoox's wordhelper cyber/hacker UI redesign
-- V20.8.43: gold/bold returned-prefix highlighting for Unbeatable + Pro Unbeatable
-- V20.8.42: restore immediate Pro/Unbeatable prompt loading; removes V20.8.40/41 throttled async experiment
-- V20.8.37: F8 anti-memorization obscure 2-10 trap randomizer
-- V20.8.36: early next-stage suggestions (T5→S2, T9→S3, T14→S4) + V20.8.34 indexing
-- WordHelper V20.8.3 lightweight launcher - Pro 489,216 / 12,546-word delta
-- V20.8.3: rejector temporarily disabled; Pro discovery recognizes the full Pro dictionary.
...
local THEME = {
    Background = Color3.fromRGB(4, 8, 6),
    ItemBG = Color3.fromRGB(9, 17, 12),
    Accent = Color3.fromRGB(45, 255, 112),
    Text = Color3.fromRGB(220, 255, 229),
    SubText = Color3.fromRGB(105, 166, 121),
    Success = Color3.fromRGB(65, 255, 125),
    Warning = Color3.fromRGB(180, 255, 80),
    Slider = Color3.fromRGB(18, 55, 30)
}
...
LoadingTitle.Text = "qoox\'s wordhelper // BOOT"
...
UpdateStatus("Loading 476,670 Casual + 12,546 Pro delta (489,216 total)...", THEME.Warning)
...
-- V20.9.4 TEMP CASUAL VALIDATION SET.
-- These 1,706 alphabetic words were recovered from the Pro FullUnion comparison.
-- They are injected into Casual for this test build only and receive absolute
-- priority while Casual Godmode is selected. Remove this block after validation.
WordHelperTempCasualTestWords = {
    ["aariya"] = true,
    ["abamectin"] = true,
    ["abamectins"] = true,
    ["abaza"] = true,
    ...
    ["aeruginosin"] = true,
    ["aeruginosins"] = true,
    ["africanfuturism"] = true,
    ["africanfuturisms"] = true,
    ["africanfuturist"] = true,
    ["africanfuturists"] = true,
    ["afrikaners"] = true,
    ["afrofuturism"] = true,
    ["afrofuturisms"] = true,
    ["afrofuturist"] = true,
    ...
    ["aminates"] = true,
    ["aminations"] = true,
    ["aminomethylated"] = true,
    ["aminomethylation"] = true,
    ["aminomethylations"] = true,
    ["amisulpride"] = true,
    ["amlexanox"] = true,
    ["amoeboflagellate"] = true,
    ["amoeboflagellates"] = true,
    ["amoxapine"] = true,
    ["amylmetacresol"] = true,
    ["anagliptin"] = true,
    ["anakinra"] = true,
    ...
    ["biohacked"] = true,
    ["biohacks"] = true,
    ["biopsychosocial"] = true,
    ["biopsychosocially"] = true,
    ["bioshelter"] = true,
    ["bioshelters"] = true,
    ["bipartiteness"] = true,
    ["bipartitenesses"] = true,
    ["bislama"] = true,
    ["boceprevir"] = true,
    ["bolewa"] = true,
    ["bonattite"] = true,
    ...
    ["deacetylase"] = true,
    ["deacetylases"] = true,
    ["deanonymisation"] = true,
    ["deanonymisations"] = true,
    ["deanonymise"] = true,
    ["deanonymised"] = true,
    ["deanonymising"] = true,
    ["deanonymization"] = true,
    ["deanonymizations"] = true,
    ["deanonymize"] = true,
    ["deanonymized"] = true,
    ["deanonymizing"] = true,
    ["deauthenticate"] = true,
    ["deauthentication"] = true,
    ["deauthentications"] = true,
    ["deauthorization"] = true,
    ["deauthorizations"] = true,
    ["deauthorize"] = true,
    ["deauthorized"] = true,
    ["deauthorizing"] = true,
    ["deerite"] = true,
    ...
    ["deidentifications"] = true,
    ["deidentified"] = true,
    ["deidentify"] = true,
    ["dek"] = true,
    ["deks"] = true,
    ["delorazepam"] = true,
    ["demethylwedelolactone"] = true,
    ["demethylwedelolactones"] = true,
    ["denatonium"] = true,
    ["densenet"] = true,
    ["densenets"] = true,
    ["deobfuscate"] = true,
    ...
    ["desmogleins"] = true,
    ["deubiquitinase"] = true,
    ["deubiquitinases"] = true,
    ["deubiquitinate"] = true,
    ["deubiquitinated"] = true,
    ["deubiquitinates"] = true,
    ["deubiquitinating"] = true,
    ["deurbanisation"] = true,
    ["deurbanisations"] = true,
    ["deurbanization"] = true,
    ["deurbanizations"] = true,
    ["devekut"] = true,
    ["dewindtite"] = true,
    ["dewindtites"] = true,
    ["dextrosursumversions"] = true,
    ["dhokla"] = true,
    ["dhoklas"] = true,
    ["dholuo"] = true,
    ["dhuwal"] = true,
    ["diablos"] = true,
    ["dibromobenzenes"] = true,
    ["dibutylnitrosamine"] = true,
    ["dibutylnitrosamines"] = true,
    ["diclazepam"] = true,
    ["didanosine"] = true,
    ["didemnin"] = true,
    ["didemnins"] = true,
    ...
    ["didots"] = true,
    ["diers"] = true,
    ["diethylnitrosamine"] = true,
    ["diethylnitrosamines"] = true,
    ["digalactosyldiacylglycerol"] = true,
    ["digalactosyldiacylglycerols"] = true,
    ["diimidazole"] = true,
    ["diimide"] = true,
    ["diimides"] = true,
    ["dijon"] = true,
    ...
    ["djugun"] = true,
    ["dluwang"] = true,
    ["dodecamethylcyclohexasiloxane"] = true,
    ["dodecamethylcyclohexasiloxanes"] = true,
    ["dodecanol"] = true,
    ["dodecanols"] = true,
    ["doramectin"] = true,
    ["doripenem"] = true,
    ...
    ["dynemicin"] = true,
    ["dynemicins"] = true,
    ["dyschondroplasia"] = true,
    ["dyschondroplasias"] = true,
    ["dysgammaglobulinemia"] = true,
    ["dysraphism"] = true,
    ["dysraphisms"] = true,
    ["dysregulate"] = true,
    ["dysregulates"] = true,
    ...
    ["emilites"] = true,
    ["encebollado"] = true,
    ["encephalomyeloradiculopathies"] = true,
    ["englishites"] = true,
    ["enone"] = true,
    ["enones"] = true,
    ["enoughness"] = true,
    ...
    ["eskaleut"] = true,
    ["esperamicin"] = true,
    ["esthesioneuroblastoma"] = true,
    ["esthesioneuroblastomas"] = true,
    ["ethyleneimine"] = true,
    ["ethylidynes"] = true,
    ["ethylphenol"] = true,
    ["ethylphenols"] = true,
    ...
    ["fischesserite"] = true,
    ["fischesserites"] = true,
    ["floccinaucinihilipilificate"] = true,
    ["floccinaucinihilipilificates"] = true,
    ["floccinaucinihilipilificatings"] = true,
    ["flualprazolam"] = true,
    ["flubromazepam"] = true,
    ["flubromazolam"] = true,
    ["fluralaner"] = true,
    ...
    ["gagauz"] = true,
    ["gairaigo"] = true,
    ["galactosylceramide"] = true,
    ["galactosylceramides"] = true,
    ["galaxolide"] = true,
    ["galaxolides"] = true,
    ["galectin"] = true,
    ["galectins"] = true,
    ...
    ["glaserites"] = true,
    ["glatiramer"] = true,
    ["glucosylceramide"] = true,
    ["glucosylceramides"] = true,
    ["glucuronidation"] = true,
    ["glucuronidations"] = true,
    ["glucuronolactone"] = true,
    ["glucuronolactones"] = true,
    ["glucuronoside"] = true,
    ["glucuronosides"] = true,
    ["glucuronoxylan"] = true,
    ["glucuronoxylans"] = true,
    ["glutamyl"] = true,
    ["glutamyls"] = true,
    ["glyoxylate"] = true,
    ["godoberi"] = true,
    ...
    ["innsbruck"] = true,
    ["iobitridol"] = true,
    ["iodochlorohydroxyquinoline"] = true,
    ["ioxaglate"] = true,
    ["ioxaglates"] = true,
    ["ipsapirone"] = true,
    ["iranite"] = true,
    ...
    ["lakshadweep"] = true,
    ["lanosterol"] = true,
    ["laparohysterosalpingooophorectomies"] = true,
    ["laquinimod"] = true,
    ["larimar"] = true,
    ["latchup"] = true,
    ["latchups"] = true,
    ...
    ["mbula"] = true,
    ["mcguinnessites"] = true,
    ["mechanosensation"] = true,
    ["mechanosensations"] = true,
    ["mechanosensing"] = true,
    ["mechanosensitive"] = true,
    ["mechanosensitivities"] = true,
    ["mechanosensitivity"] = true,
    ["mechanosensor"] = true,
    ["mechanosensors"] = true,
    ["mechanosensory"] = true,
    ["medazepam"] = true,
    ...
    ["neobladder"] = true,
    ["neobladders"] = true,
    ["neocarzinostatin"] = true,
    ["neohesperidindihydrochalcones"] = true,
    ["neolites"] = true,
    ["neonatorum"] = true,
    ["neopros"] = true,
    ["nerolidol"] = true,
    ...
    ["olenite"] = true,
    ["olenites"] = true,
    ["oleoylethanolamides"] = true,
    ["oleoyls"] = true,
    ["oleuropein"] = true,
    ["oleuropeins"] = true,
    ["olezarsen"] = true,
    ["olivopontocerebellar"] = true,
    ["oltipraz"] = true,
    ["omarigliptin"] = true,
    ["oncofertilities"] = true,
    ["oncofertility"] = true,
    ["oncoimmunological"] = true,
    ["oncoimmunologically"] = true,
    ["oncoimmunologies"] = true,
    ["oncoimmunology"] = true,
    ["oncometabolic"] = true,
    ["oncometabolite"] = true,
    ["oncometabolites"] = true,
    ["onychodystrophies"] = true,
    ["onychodystrophy"] = true,
    ["onychogryphosis"] = true,
    ["onychomatricoma"] = true,
    ["onychomatricomas"] = true,
    ["onychomatricomata"] = true,
    ["onychotillomania"] = true,
    ["onychotillomanias"] = true,
    ["opocephali"] = true,
    ["oprelvekin"] = true,
    ["opticianries"] = true,
    ["opticianry"] = true,
    ...
    ["orotate"] = true,
    ["orotated"] = true,
    ["orotatephosphoribosyltransferase"] = true,
    ["orotates"] = true,
    ["oshindonga"] = true,
    ["otavite"] = true,
    ["otavites"] = true,
    ...
    ["pyraclostrobin"] = true,
    ["pyridyls"] = true,
    ["pyrrolizidinealkaloidoses"] = true,
    ["qabili"] = true,
    ["quaterpyridine"] = true,
    ["quaterpyridines"] = true,
    ["quazepam"] = true,
    ["queryable"] = true,
    ["qusongites"] = true,
    ["qvevris"] = true,
    ...
    ["tupuri"] = true,
    ["tuyuca"] = true,
    ["tympanomastoidectomies"] = true,
    ["tympanomastoidectomy"] = true,
    ["ubidecarenone"] = true,
    ["ubiquinol"] = true,
    ["ubiquinols"] = true,
    ["ubiquitinate"] = true,
...
WordHelperTempCasualTestCount = 0
for testWord in pairs(WordHelperTempCasualTestWords) do
    if not WordHelperKnownWords[testWord] then
        WordHelperKnownWords[testWord] = true
        table.insert(Words, testWord)
        WordHelperTempCasualTestCount = WordHelperTempCasualTestCount + 1
    end
end
UpdateStatus("TEMP: injected " .. tostring(WordHelperTempCasualTestCount) .. " recovered Casual test words!", THEME.Success)
...
GodmodeConfirmedTwoLetter = {
    ["sd"]=true, ["mg"]=true, ["rg"]=true, ["yg"]=true, ["yp"]=true,
    ["yc"]=true, ["mh"]=true, ["nh"]=true, ["dh"]=true, ["dz"]=true,
    ["lw"]=true, ["dw"]=true, ["sf"]=true, ["tx"]=true, ["kt"]=true,
...
GodmodeMatchesConfiguredPriority = function(word)
    -- V20.9.4 TEMP: recovered-word validation outranks every normal Godmode category.
    if WordHelperTempCasualTestWords and WordHelperTempCasualTestWords[word] then
        return true, 0, false
    end
...
GodmodeGetPriorityCategory = function(word)
    -- V20.9.4 TEMP: make recovered words visibly/strategically absolute priority.
    if WordHelperTempCasualTestWords and WordHelperTempCasualTestWords[word] then
        return "TEST NEW", 0, false, nil
    end
...
-- V20.8.8 LONG-WORD DISPLAY LOCK
-- Last Letter's CurrentWord presentation can become a sliding/truncated window on
-- very long entries. WordHelper used to interpret that window as a brand-new prefix,
-- causing the selected long suggestion to disappear midway through typing.
--
-- Once the player has clearly begun the current long recommendation, preserve that
-- target and reconstruct the logical full typed prefix from the visible window.
env.WordHelperLongWord = env.WordHelperLongWord or {
    Word = "",
    Progress = 0,
    LastVisible = "",
    Active = false
...
env.WordHelperLongWord.Reset = function()
    env.WordHelperLongWord.Word = ""
    env.WordHelperLongWord.Progress = 0
    env.WordHelperLongWord.LastVisible = ""
    env.WordHelperLongWord.PreviousDetected = ""
    env.WordHelperLongWord.SlidingFull = ""
    env.WordHelperLongWord.SlidingWindow = ""
    env.WordHelperLongWord.Active = false
end

env.WordHelperLongWord.MaybeLock = function(word, typedPrefix)
    -- V20.8.12: deliberately disabled. Long-word handling is now reconstruction-only,
    -- so backspacing immediately restores the normal dynamic suggestion list.
    return
end

env.WordHelperLongWord.ReconstructSliding = function(previousText, rawText)
    local state = env.WordHelperLongWord
    local function clean(v)
        v = tostring(v or ""):lower():gsub("%.%.%.", ""):gsub("…", "")
        return v:gsub("[^a-z'%-]", "")
    end
    local previous = clean(previousText)
    local raw = tostring(rawText or ""):lower()
    local overflow = raw:find("%.%.%.") ~= nil or raw:find("…",1,true) ~= nil
    local visible = clean(raw)

    if not overflow then
        state.SlidingFull, state.SlidingWindow = visible, visible
        return visible
    end

    local full = clean(state.SlidingFull or previous)
    local oldWindow = clean(state.SlidingWindow or "")
    if full == "" then full = previous end
    if visible == "" then return full end

    local pos, from = nil, 1
    while true do
        local p = full:find(visible, from, true)
        if not p then break end
        pos, from = p, p + 1
    end
    if pos then
        full = full:sub(1,pos-1)..visible
        state.SlidingFull,state.SlidingWindow=full,visible
        return full
    end

    for overlap=math.min(#full,#visible),1,-1 do
        if full:sub(-overlap)==visible:sub(1,overlap) then
            full=full..visible:sub(overlap+1)
            state.SlidingFull,state.SlidingWindow=full,visible
            return full
        end
    end

    -- Typo recovery uses letters only for comparison, but retains exact punctuation.
    if oldWindow~="" then
        local oldLetters=oldWindow:gsub("[^a-z]","")
        local newLetters=visible:gsub("[^a-z]","")
        local common,limit=0,math.min(#oldLetters,#newLetters)
        for i=1,limit do
            if oldLetters:sub(i,i)~=newLetters:sub(i,i) then break end
            common=i
        end
        if common>=math.min(3,limit) then
            local oldPos=full:find(oldWindow,1,true)
            if oldPos then
                full=full:sub(1,oldPos-1)..visible
                state.SlidingFull,state.SlidingWindow=full,visible
                return full
            end
        end
    ...
    state.SlidingWindow=visible
    return full
end

env.WordHelperLongWord.Resolve = function(visibleText, requiredLetter)
    -- Preserve real Pro-prefix punctuation such as t-i and apostrophe prefixes.
    local text = tostring(visibleText or ""):lower()
    text = text:gsub("%.%.%.", ""):gsub("…", "")
    return text:gsub("[^a-z'%-]", "")
end

env.WordHelperLongWord.Reset()
...
env.WordHelperBlacklistTracker.Add = function(word, reason)
    -- V20.8.38: MANUAL blacklist is restored. Automatic rejection detection stays OFF.
    word = tostring(word or ""):lower():gsub("%s+", "")
    if #word < 2 then return false end

    -- Preserve a canonical punctuated Pro spelling when the typed/manual form maps
    -- uniquely to one. This keeps blacklist behavior correct for apostrophe/hyphen words.
    local norm = word:gsub("[^a-z]", "")
    if env.WordHelperUnbeatable and env.WordHelperUnbeatable.ProDictionaryNormalizedUnique then
        local canonical = env.WordHelperUnbeatable.ProDictionaryNormalizedUnique[norm]
        if canonical then word = canonical end
    end

    if Blacklist[word] or UsedWords[word] then return false end
    Blacklist[word] = true

    if env.WordHelperUnbeatable then
        if env.WordHelperUnbeatable.AdjustUnavailableWord then
            env.WordHelperUnbeatable.AdjustUnavailableWord(word, 1)
        end
        if env.WordHelperUnbeatable.AdjustProDeltaUnavailableWord then
            env.WordHelperUnbeatable.AdjustProDeltaUnavailableWord(word, 1)
        end
        env.WordHelperUnbeatable.ProForcedReplyCache = {}
    ...
    if ShowToast then
        ShowToast("Manually blacklisted: " .. word, "warning")
    end
...
-- V20.8.38: load the persistent MANUAL blacklist. Automatic reject detection remains disabled.
...
-- V20.8.39: records where each accepted unknown word was actually discovered.
-- Values: CASUAL, PRO, BOTH, or LEGACY for pre-V20.8.39 saved discoveries.
env.WordHelperDiscovery.PendingMode = env.WordHelperDiscovery.PendingMode or {}
...
env.WordHelperDiscovery.IsKnownWord = function(word)
    ...
    -- Casual/base dictionary membership.
    if WordHelperKnownWords[word] == true then
        return true
    end

    -- V20.8.3: while Pro Unbeatable is active, discovery must compare against
    -- the ENTIRE Pro pool, not only the 476,670-word Casual base.  The Pro
    -- delta keeps normalized lookup keys because many source entries contain
    -- punctuation that the in-game submitted word does not expose.
    if sortMode == "Pro Unbeatable" and env.WordHelperUnbeatable then
        if env.WordHelperUnbeatable.ProDictionaryDeltaSet
            and env.WordHelperUnbeatable.ProDictionaryDeltaSet[word] then
            return true
        end
        if env.WordHelperUnbeatable.ProDictionaryNormalizedUnique
            and env.WordHelperUnbeatable.ProDictionaryNormalizedUnique[word] then
            return true
        end
        if env.WordHelperUnbeatable.ProExclusiveSet
            and env.WordHelperUnbeatable.ProExclusiveSet[word] then
            return true
        end
        if env.WordHelperUnbeatable.ProExclusiveNormalized
            and env.WordHelperUnbeatable.ProExclusiveNormalized[word] then
            return true
        end
    end
    ...
    pcall(function()
        writefile(
            ...
            HttpService:JSONEncode({
                ...
                pendingMode = env.WordHelperDiscovery.PendingMode,
...
env.WordHelperDiscovery.Load = function()
    ...
    -- V20.8.39: old save files had no mode metadata. Keep those entries visible
    -- as LEGACY rather than guessing whether they came from Casual or Pro.
    if type(decoded.pendingMode) == "table" then
        for word, mode in pairs(decoded.pendingMode) do
            local clean = tostring(word):lower():gsub("[^a-z]", "")
            mode = tostring(mode or ""):upper()
            if #clean >= 2 and (mode == "CASUAL" or mode == "PRO" or mode == "BOTH") then
                env.WordHelperDiscovery.PendingMode[clean] = mode
            end
        end
    end
    for word in pairs(env.WordHelperDiscovery.Pending) do
        if not env.WordHelperDiscovery.PendingMode[word] then
            env.WordHelperDiscovery.PendingMode[word] = "LEGACY"
        end
    end
...
env.WordHelperDiscovery.RefreshUI = function()
    ...
    for index, word in ipairs(words) do
        ...
        local discoveredMode = env.WordHelperDiscovery.PendingMode[word] or "LEGACY"
        local modeTag = discoveredMode == "PRO" and "[PRO]"
            or discoveredMode == "CASUAL" and "[CASUAL]"
            or discoveredMode == "BOTH" and "[BOTH]"
            or "[OLD]"
        label.Text = modeTag .. "  " .. word .. "  x" .. tostring(env.WordHelperDiscovery.Pending[word] or 1)
    ...
    if env.WordHelperDiscovery.Header then
        env.WordHelperDiscovery.Header.Text =
            "Discovered Words (" .. tostring(#words) .. ")  C/P"
    end
...
env.WordHelperDiscovery.Approve = function(word, silent)
    ...
    if env.WordHelperDiscovery.IsKnownWord(word) then
        ...
        env.WordHelperDiscovery.PendingMode[word] = nil
    ...
    -- A word learned on a Pro server belongs only to the isolated Pro custom pool.
    -- Casual/BOTH discoveries use the normal dictionary, which is also available to Pro.
    if discoveredMode == "PRO" then
        Config.ProCustomWords = Config.ProCustomWords or {}
        local alreadyPro = false
        local norm = word:gsub("[^a-z]", "")
        for _, existing in ipairs(Config.ProCustomWords) do
            if tostring(existing):lower():gsub("[^a-z]", "") == norm then
                alreadyPro = true
                break
            end
        end
        if not alreadyPro then table.insert(Config.ProCustomWords, word) end
        ...
        if env.WordHelperDiscovery.SessionSeen[word] then UsedWords[word] = true end
        env.WordHelperDiscovery.Save()
        SaveConfig()

        if env.WordHelperUnbeatable and env.WordHelperUnbeatable.RefreshProExclusiveWords then
        ...
        if not silent and ShowToast then
            ShowToast("Added discovered Pro word: " .. word, "success")
        end
        return true
    end
...
env.WordHelperDiscovery.ConsiderAccepted = function(word, source)
    ...
    -- Capture the server/mode at the moment the game confirms acceptance.
    local foundMode = (sortMode == "Pro Unbeatable") and "PRO" or "CASUAL"
    local previousMode = env.WordHelperDiscovery.PendingMode[word]
    if previousMode and previousMode ~= "LEGACY" and previousMode ~= foundMode then
        env.WordHelperDiscovery.PendingMode[word] = "BOTH"
    elseif not previousMode or previousMode == "LEGACY" then
        env.WordHelperDiscovery.PendingMode[word] = foundMode
    end
    ...
    if ShowToast then
        ShowToast("Discovered " .. ((sortMode == "Pro Unbeatable") and "Pro" or "Casual") .. " word: " .. word, "success")
    end
    return true
end
...
env.WordHelperDiscovery.PacketExtractWord = function(buf)
    ...
    for _, raw in ipairs(runs) do
        ...
        if raw:match("^[A-Z][A-Z'%-]*$") and #raw >= 2 and #raw <= 40 then
...
env.WordHelperDiscovery.PacketHandle = function(...)
    ...
    if packetId == 15 then -- AnswerResults
        ...
        if candidate ~= "" and (now - candidateAt) <= 0.45 then
            ...
            -- V20.8.6 SERVER-CONFIRMED USED WORD:
            -- Diagnostic #2 established the repeatable sequence:
            --   packet 26 (ChatBubble carrying the COMPLETE submitted word)
            --   -> packet 15 (AnswerResults)
            --   -> packet 8 (next returned prefix)
            -- Record the packet candidate here, at AnswerResults, rather than waiting
            -- for CurrentWord/Type UI to settle. This catches ultra-fast opponent words
            -- that may never exist for a full rendered frame on this client.
            --
            -- Crucially, this also eliminates the historical self-solve ambiguity:
            -- a returned prefix that happens to be a valid dictionary word is NOT a
            -- ChatBubble+AnswerResults submission, so the prompt itself is never marked
            -- used by this primary path. Only the exact completed submitted word is.
            if env.WordHelperUsedTracker
                and env.WordHelperUsedTracker.RecordObservedUsedWord then
                pcall(env.WordHelperUsedTracker.RecordObservedUsedWord, candidate, true)
            end
        else
...
env.WordHelperDiscovery.BuildUI = function()
    ...
    env.WordHelperDiscovery.SearchBox.Font = Enum.Font.Code
...
Title.Text = "<font color=\"rgb(45,255,112)\">qoox\'s</font> wordhelper <font color=\"rgb(105,166,121)\">// V20.9.4 TEMP</font>"
Title.RichText = true
...
StatusFrame.Position = UDim2.new(0, 15, 0, 61)
...
SearchFrame.Position = UDim2.new(0, 5, 0, 90)
...
SearchBox.PlaceholderText = "> search dictionary_"
...
ScrollList.Size = UDim2.new(1, -10, 1, -238)
ScrollList.Position = UDim2.new(0, 5, 0, 128)
...
env.WordHelperBlacklistBtn.Visible = true -- V20.8.38 manual blacklist restored
env.WordHelperBlacklistBtn.Text = "Manual Blacklist"
...
env.WordHelperBlacklistFrame.Visible = false -- V20.8.38 manual blacklist manager
...
env.WordHelperBlacklistHeader.Text = "Manual Blacklist"
...
env.WordHelperBlacklistTracker.Refresh = function()
    ...
    env.WordHelperBlacklistHeader.Text = "Manual Blacklist (" .. #words .. ")"
...
local function UnbeatableStageForCompletedTurns(completedTurns)
    ...
    -- Confirmed rule: turns 1-5=S1, 6-10=S2, 11-15=S3, 16+=S4.
    return ((completedTurns >= 13 and 4)
    or (completedTurns >= 8 and 3)
    or (completedTurns >= 4 and 2)
    or 1)
end
...
-- UsedWords is populated by the authoritative server AnswerResults path.
-- Five completed answers means the NEXT turn is turn 6/stage 2; ten means
-- turn 11/stage 3; fifteen means turn 16/stage 4. MatchStartUsedCount lets F5 restart
...
-- ============================================================
-- V20.8.2 PRO 489,216 DICTIONARY DELTA
-- The normal 476,670 Casual dictionary remains untouched.  This embedded
-- delta contains only the 12,546 additional words present in the user's
-- current 489,216-word Pro union, so Pro Unbeatable gets the full Pro pool
...
-- ============================================================
env.WordHelperUnbeatable.ProDictionaryTotal = 489216
...
de-institutionalizations
de-internationalisation
de-internationalisations
de-internationalization
de-internationalizations
de-judaisation
de-judaisations
de-judaization
de-judaizations
...
front-ends
front-ends-as-a-service
frontend-as-a-service
frontends-as-a-service
frou-frou
frou-frous
...
homo-oligomerisations
homo-oligomerization
homo-oligomerizations
homoanatoxin-a
homoanatoxin-as
honest-to-god
honky-tonk
...
iodosulfuron-methyl-sodiums
iodosulfuron-methyls
...
isopropyl-beta-d-thiogalactopyranosides
ispinesib
istisqa'
istisqaa'
istriot
...
learner-centerednesses
learner-centredness
learner-centrednesses
learning-as-a-service
learnings-as-a-service
lease-up
lease-ups
...
magnesio-arfvedsonites
magnesio-carbonatites
magnesio-hastingsites
magnesio-hornblende
magnesio-wustite
magnesio-wustites
magnetite-ulvospinel
magnetite-ulvospinels
magpie-jay
magpie-jays
magpie-lark
magpie-larks
...
micro-spectrophotometric
micro-spectrophotometrically
micro-spectrophotometries
...
pharmaco-electroencephalographies
pharmaco-electroencephalography
phi-coefficient
phi-coefficients
phishing-as-a-service
phishings-as-a-service
phone-in
phone-ins
phospho-acceptor
phospho-acceptors
...
stereo-electroencephalographies
...
stimuli-responsivenesses
stimulus-responsiveness
stimulus-responsivenesses
stone-cold
stone-curlew
stone-curlews
stop-and-frisk
...
sulphamethoxazole-trimethoprims
...
tert-amyl
tert-amyls
tert-butanesulfinamides
tert-butanesulphinamide
tert-butanesulphinamides
tert-butyl
tert-butylamine
tert-butylamines
...
three-dimensionalisms
three-dimensionalist
three-dimensionalists
...
env.WordHelperUnbeatable.AdjustProDeltaUnavailableWord = function(word, deltaAmount)
    -- Canonical Pro entries may contain apostrophes/hyphens; keep them intact.
    word = tostring(word or ""):lower():gsub("%s+", "")
...
env.WordHelperUnbeatable.RefreshProExclusiveWords = function()
    ...
    local function add(word)
        ...
        -- V20.8.2: the 489,216-word Pro union already contains the old hardcoded
...
env.WordHelperUnbeatable.ProSpicyUsedPrefixes =
    env.WordHelperUnbeatable.ProSpicyUsedPrefixes or {}
env.WordHelperUnbeatable.ProSpicyRecentWordPrefix =
    env.WordHelperUnbeatable.ProSpicyRecentWordPrefix or {}
...
-- V20.8.37 F8 ANTI-MEMORIZATION OBSCURITY SCORE.
-- Used only by Spicy Random at Stage 3/4. It rewards visually awkward returns
-- (rare letters, consonant clusters, no-vowel forms) and downranks familiar
-- English-looking fragments. Normal Pro and F9 never consult this score.
env.WordHelperUnbeatable.ProSpicyObscurityScore = function(prefix)
    prefix = tostring(prefix or ""):lower()
    local score = 0
    local vowels = 0
    local consonantRun = 0
    local longestRun = 0
    for i = 1, #prefix do
        ...
        elseif c:find("[a-z]") then
            consonantRun = consonantRun + 1
            if consonantRun > longestRun then longestRun = consonantRun end
            if c == "q" or c == "x" or c == "z" or c == "j" then
                score = score + 4
            elseif c == "k" or c == "v" or c == "w" or c == "y" then
                score = score + 2
            end
        else
            score = score + 3
    ...
    if vowels == 0 then score = score + 5 end
    if longestRun >= 2 then score = score + (longestRun - 1) * 3 end
    if longestRun >= 3 then score = score + 3 end

    -- Familiar-looking fragments are less useful for the anti-memorization pool.
    local familiar = {"ing","ion","tio","ent","ers","ter","est","all","ally","onic","ness","ment"}
    for _,frag in ipairs(familiar) do
        if prefix:find(frag,1,true) then score = score - 5 end
    end
    return score
end
...
env.WordHelperUnbeatable.IsProWordUnavailable = function(word)
    word = tostring(word or ""):lower()
    if Blacklist[word] == true or UsedWords[word] == true then return true end

    -- Server packets may omit punctuation from a Pro spelling. Resolve the unique
    -- normalized identity so that the canonical Pro word is still treated as used.
    local norm = word:gsub("[^a-z]", "")
    if env.WordHelperUsedTracker
        and env.WordHelperUsedTracker.NormalizedUsed
        and env.WordHelperUsedTracker.NormalizedUsed[norm] then
        return true
    end
    ...
    return canonical ~= nil
        and (Blacklist[canonical] == true or UsedWords[canonical] == true)
end
...
-- V20.8.27 PRO GODMODE (F9) TRAP BANKS
-- Confirmed Pro Stage-2 returns. These are promoted as traps ONLY at Stage 2.
env.WordHelperUnbeatable.ProGodmodeTwoLetterTraps = {
    zi=true, sd=true, md=true, mg=true, rg=true, yg=true, yp=true, yc=true,
    mh=true, nh=true, dh=true, kh=true, dz=true, lw=true, dw=true, sf=true,
    sv=true, tz=true, tx=true, kt=true, nk=true, hl=true, yw=true, bt=true,
    mb=true, fd=true, pk=true, sz=true, hd=true, pf=true, cw=true, kw=true,
    sb=true, sg=true, mz=true, ez=true, pc=true, fs=true, tg=true, wd=true,
    mv=true, vp=true, rz=true, pm=true
}
-- User-confirmed Pro-only spicy returns. GD is retained here as requested even
-- though it was not in the general list above.
env.WordHelperUnbeatable.ProGodmodePriorityTwoLetterTraps = {
    rz=true, vp=true, mz=true, gd=true, wd=true, pm=true
}

-- V20.8.20 DIVERSIFIED PRO SPAM MODE (F9)
-- Instead of filling the list with many words from the first available ending,
-- F9 exposes ONE best representative from every available Godmode priority category.
-- LOWEST ENTRY is ignored positionally and becomes the final normal-Pro fallback.
-- TRAP and X remain real selectable categories; literal endings use the shared editor.
env.WordHelperUnbeatable.ProSpamMode = env.WordHelperUnbeatable.ProSpamMode or false
env.WordHelperUnbeatable.ProSpamChoiceCache = env.WordHelperUnbeatable.ProSpamChoiceCache or {}
env.WordHelperUnbeatable.ProSpamChoiceCacheKey = env.WordHelperUnbeatable.ProSpamChoiceCacheKey or ""
env.WordHelperUnbeatable.ProSpamChoiceCacheAt = env.WordHelperUnbeatable.ProSpamChoiceCacheAt or 0

-- V20.8.30 INDEXED PRO SEARCH CACHE
-- Structural discovery is cached by the exact candidate-set signature + stage.
-- UsedWords changes naturally alter the candidate list/signature, so stale live
-- results are not reused.
env.WordHelperUnbeatable.ProDiscoveryCache =
    env.WordHelperUnbeatable.ProDiscoveryCache or {}
env.WordHelperUnbeatable.ProDiscoveryCacheOrder =
    env.WordHelperUnbeatable.ProDiscoveryCacheOrder or {}

-- V20.8.31 PREBUILT / LAZY PRO SUFFIX METADATA INDEX
-- Each Pro word's 1..4 suffixes and punctuation eligibility are computed once,
-- then reused by every future prefix query. The table persists for the session.
env.WordHelperUnbeatable.ProWordSuffixMeta =
    env.WordHelperUnbeatable.ProWordSuffixMeta or {}

env.WordHelperUnbeatable.GetProWordSuffixMeta = function(word)
    local cached = env.WordHelperUnbeatable.ProWordSuffixMeta[word]
    if cached then return cached end

    local meta = {}
    local maxLen = math.min(4, #word)
    for suffixLen = 1, maxLen do
        local prefix = word:sub(-suffixLen)
        local startsWithLetter = prefix:match("^[a-z]") ~= nil
        local hasPunctuation = prefix:find("'", 1, true) ~= nil
            or prefix:find("-", 1, true) ~= nil
        meta[suffixLen] = {
            Prefix = prefix,
            Eligible = startsWithLetter
                and ((not hasPunctuation) or suffixLen >= 3)
        }
    end

    env.WordHelperUnbeatable.ProWordSuffixMeta[word] = meta
    return meta
end

-- V20.8.32 REVERSE STRATEGIC INDEX
-- Cache strategic representatives by [stage][starting-prefix signature]. Unlike the
-- old forward scan, once a structural representative set is learned it is reused
-- directly and only the small finalist set receives live Pro analysis.
env.WordHelperUnbeatable.ProReverseStrategicIndex =
    env.WordHelperUnbeatable.ProReverseStrategicIndex or {}

-- V20.8.33 BACKGROUND PRO INDEX PREPARATION
env.WordHelperUnbeatable.ProBackgroundIndex =
    env.WordHelperUnbeatable.ProBackgroundIndex or {
        Started=false, Ready=false, Done=0, Total=0, Percent=0
    }

env.WordHelperUnbeatable.StartProBackgroundIndex = function()
    local bg=env.WordHelperUnbeatable.ProBackgroundIndex
    if bg.Started then return end
    bg.Started=true

    task.spawn(function()
        -- FullUnion is the canonical Pro dictionary already built by this script.
        local source=FullUnion or {}
        bg.Total=#source
        bg.Done=0
        bg.Percent=0

        -- Precompute the exact 1..4 suffix metadata used by Normal Pro. Work is
        -- deliberately chunked so preparation never monopolizes a frame.
        for i,w in ipairs(source) do
            env.WordHelperUnbeatable.GetProWordSuffixMeta(w)
            bg.Done=i
            if i % 800 == 0 then
                bg.Percent=math.floor((i/math.max(1,bg.Total))*100)
                env.WordHelperUnbeatable.ProIndexStatus=
                    "Pro Index: Building " .. tostring(bg.Percent) .. "%"
                task.wait()
            end
        end
        ...
        bg.Percent=100
        bg.Ready=true
        env.WordHelperUnbeatable.ProIndexStatus="Pro Index: Ready"
        forceUpdateList=true
    end)
end

-- Start as soon as all helper definitions exist. This occurs independently of
-- incoming game prefixes.
env.WordHelperUnbeatable.StartProBackgroundIndex()

-- V20.8.34 visible background-index indicator.
-- Stored on env to avoid Luau top-level local-register pressure.
pcall(function()
    if env.WordHelperProIndexGui then
        env.WordHelperProIndexGui:Destroy()
    end
    env.WordHelperProIndexGui=Instance.new("ScreenGui")
    env.WordHelperProIndexGui.Name="WordHelperProIndexStatus"
    env.WordHelperProIndexGui.ResetOnSpawn=false
    env.WordHelperProIndexGui.IgnoreGuiInset=true
    env.WordHelperProIndexGui.Parent=game:GetService("CoreGui")

    env.WordHelperProIndexLabel=Instance.new("TextLabel")
    env.WordHelperProIndexLabel.Name="Status"
    env.WordHelperProIndexLabel.AnchorPoint=Vector2.new(1,0)
    env.WordHelperProIndexLabel.Position=UDim2.new(1,-18,0,18)
    env.WordHelperProIndexLabel.Size=UDim2.new(0,245,0,30)
    env.WordHelperProIndexLabel.BackgroundTransparency=0.2
    env.WordHelperProIndexLabel.TextScaled=false
    env.WordHelperProIndexLabel.TextSize=16
    env.WordHelperProIndexLabel.Font=Enum.Font.GothamBold
    env.WordHelperProIndexLabel.TextXAlignment=Enum.TextXAlignment.Center
    env.WordHelperProIndexLabel.Text="Pro Index: Starting..."
    env.WordHelperProIndexLabel.Parent=env.WordHelperProIndexGui

    task.spawn(function()
        while env.WordHelperProIndexLabel
            and env.WordHelperProIndexLabel.Parent do
            local bg=env.WordHelperUnbeatable
                and env.WordHelperUnbeatable.ProBackgroundIndex
            if bg then
                if bg.Ready then
                    env.WordHelperProIndexLabel.Text="Pro Index: Ready (100%)"
                    task.wait(3)
                    if env.WordHelperProIndexLabel
                        and env.WordHelperProIndexLabel.Parent then
                        env.WordHelperProIndexLabel.Visible=false
                    end
                    break
                else
                    env.WordHelperProIndexLabel.Text=
                        "Pro Index: Building " .. tostring(bg.Percent or 0) .. "%"
                end
            end
            task.wait(0.15)
        end
...
env.WordHelperUnbeatable.SelectTopProCandidates = function(candidateList)
    -- V20.8.27: F9 is now a true lightweight "Pro Godmode".
    -- It does NOT run full Pro analysis across the whole candidate pool.
    if env.WordHelperUnbeatable.ProSpamMode then
        local stage = math.clamp(tonumber(env.WordHelperUnbeatable.Stage) or 1, 1, 4)
        local result, seen = {}, {}
        local categoryBest = {}
        local priorityTrapPool, normalTrapPool = {}, {}
        local priorityTrapSeen, normalTrapSeen = {}, {}
        local ordinaryPool = {}
        ...
        -- Cheap single pass: discover literal spam representatives and Stage-2 traps.
        for _, w in ipairs(candidateList) do
            if stage == 2 and #w >= 2 then
                local ending = w:sub(-2)
                if env.WordHelperUnbeatable.ProGodmodeTwoLetterTraps[ending]
                    or env.WordHelperUnbeatable.ProGodmodePriorityTwoLetterTraps[ending] then
                    local target = env.WordHelperUnbeatable.ProGodmodePriorityTwoLetterTraps[ending]
                        and priorityTrapPool or normalTrapPool
                    local targetSeen = env.WordHelperUnbeatable.ProGodmodePriorityTwoLetterTraps[ending]
                        and priorityTrapSeen or normalTrapSeen
                    if not targetSeen[ending] then
                        targetSeen[ending] = true
                        target[#target + 1] = w
                    end
                end
            end

            for ci, category in ipairs(Config.GodmodePriority or {}) do
                if category ~= "__TRAP__" and category ~= "__LOWEST_ENTRY__" then
                    local eligible = category == "__X__"
                        or (type(category) == "string" and #category <= stage)
                    if eligible and not categoryBest[ci] then
                        if category == "__X__" then
                            if w:sub(-1) == "x" then categoryBest[ci] = w end
                        elseif #w >= #category and w:sub(-#category) == category then
                            categoryBest[ci] = w
                        end
                    end
                end
            ...
            if #ordinaryPool < 40 then ordinaryPool[#ordinaryPool + 1] = w end
        end
        ...
        shuffle(priorityTrapPool)
        shuffle(normalTrapPool)

        -- Two different spicy traps every Stage-2 query. Requested Pro-only traps
        -- are drawn first; remaining confirmed traps fill any open trap slot.
        if stage == 2 then
            local trapCount = 0
            for _, w in ipairs(priorityTrapPool) do
                add(w); trapCount = trapCount + 1
                if trapCount >= 2 then break end
            end
            if trapCount < 2 then
                for _, w in ipairs(normalTrapPool) do
                    if not seen[w] then
                        add(w); trapCount = trapCount + 1
                        if trapCount >= 2 then break end
                    end
        ...
        -- One representative of every stage-available spam ending, in editor order.
        for ci = 1, #(Config.GodmodePriority or {}) do
            add(categoryBest[ci])
        end

        -- Preserve the "lowest reply possible" playstyle where it matters, but only
        -- analyze a bounded shortlist instead of every Pro candidate. This is the
        -- expensive part, so cap it hard and reuse the existing canonical Pro logic.
        local strategicPool = {}
        local strategicSeen = {}
        local function consider(w)
            if w and not seen[w] and not strategicSeen[w] and #strategicPool < 72 then
                strategicSeen[w] = true
                strategicPool[#strategicPool + 1] = w
            end
        end
        for _, w in ipairs(ordinaryPool) do consider(w) end
        for _, w in ipairs(priorityTrapPool) do consider(w) end
        for _, w in ipairs(normalTrapPool) do consider(w) end

        local scored = {}
        for _, w in ipairs(strategicPool) do
            local info = env.WordHelperUnbeatable.GetProCandidateInfo(w)
            if info then
                local total = (tonumber(info.NonSelfReplies) or 999999)
                    + (info.SelfSolve == true and 1 or 0)
                scored[#scored + 1] = {Word=w, Total=total, Self=info.SelfSolve == true}
            end
        end
        table.sort(scored, function(a,b)
            if a.Total ~= b.Total then return a.Total < b.Total end
            if a.Self ~= b.Self then return not a.Self end
        ...
        -- Absolute no-empty fallback: untouched valid candidates.
        if #result < 40 then
            for _, w in ipairs(candidateList) do
                add(w)
                if #result >= 40 then break end
    ...
    -- V20.8.32 NORMAL PRO REVERSE-INDEX QUERY.
    local originalCandidateList = candidateList
    local stage = math.clamp(tonumber(env.WordHelperUnbeatable.Stage) or 1, 1, 4)
    local firstCandidate = originalCandidateList[1] or ""
    local lastCandidate = originalCandidateList[#originalCandidateList] or ""
    local structuralKey = table.concat({
        "v33", "s" .. tostring(stage), tostring(#originalCandidateList),
        firstCandidate, lastCandidate
    }, "|")

    local reverse = env.WordHelperUnbeatable.ProReverseStrategicIndex[structuralKey]
    local shortlist, spicyStageTwo, regularStageTwo, obscureStageReturns

    if reverse then
        shortlist, spicyStageTwo, regularStageTwo, obscureStageReturns = {}, {}, {}, {}
        -- Live availability filtering is deliberately applied only to the indexed
        -- representatives, never to the whole candidate pool.
        for _,w in ipairs(reverse.Shortlist or {}) do
            if not env.WordHelperUnbeatable.IsProWordUnavailable(w) then
                shortlist[#shortlist+1]=w
            end
        end
        for _,w in ipairs(reverse.Spicy or {}) do
            if not env.WordHelperUnbeatable.IsProWordUnavailable(w) then
                spicyStageTwo[#spicyStageTwo+1]=w
            end
        end
        for _,w in ipairs(reverse.Regular or {}) do
            if not env.WordHelperUnbeatable.IsProWordUnavailable(w) then
                regularStageTwo[#regularStageTwo+1]=w
            end
        end
        for _,w in ipairs(reverse.Obscure or {}) do
            if not env.WordHelperUnbeatable.IsProWordUnavailable(w) then
                obscureStageReturns[#obscureStageReturns+1]=w
            end
        end
    else
        -- One-time learning pass for this structural candidate bucket. Crucially,
        -- the learned reverse representatives are independent of UsedWords, so the
        -- same starting-prefix bucket does not need to be rediscovered every turn.
        shortlist, spicyStageTwo, regularStageTwo, obscureStageReturns = {}, {}, {}, {}
        local shortlistSeen, spicySeen, regularSeen = {}, {}, {}
        local returnBest = {}
        local xBest = nil

        local function easier(a,b)
            return b==nil or #a<#b or (#a==#b and a<b)
        end
        local function add(w)
            if w and not shortlistSeen[w] then
                shortlistSeen[w]=true; shortlist[#shortlist+1]=w
            end
        end

        for _,w in ipairs(originalCandidateList) do
            local meta=env.WordHelperUnbeatable.GetProWordSuffixMeta(w)
            if meta[1] and meta[1].Prefix=="x" and easier(w,xBest) then xBest=w end

            -- Structural longest-return discovery uses base dictionary counts only;
            -- live UsedWords is intentionally deferred to the tiny finalist set.
            local chosenPrefix, total, selfSolve=nil,999999,false
            for suffixLen=math.min(stage,#w),1,-1 do
                local sm=meta[suffixLen]
                if sm and sm.Eligible then
                    local count,selfWord=env.WordHelperUnbeatable.GetProBaseReplyInfo(sm.Prefix)
                    if count and count>=1 then
                        chosenPrefix=sm.Prefix
                        selfSolve=selfWord==true and w~=sm.Prefix
                        total=count
                        break
                    end
                end
            end
            if chosenPrefix then
                local old=returnBest[chosenPrefix]
                if old==nil or easier(w,old.Word) then
                    returnBest[chosenPrefix]={
                        Word=w, Prefix=chosenPrefix, Total=total, Self=selfSolve
                    }
                end
            end
        end
        ...
        local discovered={}
        for _,row in pairs(returnBest) do discovered[#discovered+1]=row end
        ...
        -- F8 Stage 3/4 pool: exact-stage returns with 2-10 base answers.
        -- Keep a generous structural bank so famous 1-answer traps do not crowd
        -- the weird multi-answer prefixes out of the 180-word Normal shortlist.
        if stage==3 or stage==4 then
            local obscureRows={}
            for _,row in ipairs(discovered) do
                if #row.Prefix==stage and row.Total>=2 and row.Total<=10 then
                    obscureRows[#obscureRows+1]=row
                end
            end
            table.sort(obscureRows,function(a,b)
                local oa=env.WordHelperUnbeatable.ProSpicyObscurityScore(a.Prefix)
                local ob=env.WordHelperUnbeatable.ProSpicyObscurityScore(b.Prefix)
                if oa~=ob then return oa>ob end
                if #a.Word~=#b.Word then return #a.Word<#b.Word end
                return a.Word<b.Word
            end)
            for i=1,math.min(260,#obscureRows) do
                obscureStageReturns[#obscureStageReturns+1]=obscureRows[i].Word
            end
        end
        ...
        if stage==2 then
            for _,row in ipairs(discovered) do
                local p=row.Prefix
                if #p==2 and env.WordHelperUnbeatable.ProGodmodePriorityTwoLetterTraps[p]
                    and not spicySeen[p] then
                    spicySeen[p]=true; spicyStageTwo[#spicyStageTwo+1]=row.Word
                elseif #p==2 and env.WordHelperUnbeatable.ProGodmodeTwoLetterTraps[p]
                    and not regularSeen[p] then
                    regularSeen[p]=true; regularStageTwo[#regularStageTwo+1]=row.Word
                end
            end
            for _,w in ipairs(spicyStageTwo) do add(w) end
            for _,w in ipairs(regularStageTwo) do add(w) end
        end

        add(xBest)
        for _,row in ipairs(discovered) do
            if row.Total<=4 then add(row.Word) end
            if #shortlist>=180 then break end
        end
        if #shortlist<180 then
            for _,row in ipairs(discovered) do
                add(row.Word)
                if #shortlist>=180 then break end
            end
        end
        if #shortlist<40 then
            for _,w in ipairs(originalCandidateList) do
                add(w)
                if #shortlist>=40 then break end
            end
        end

        env.WordHelperUnbeatable.ProReverseStrategicIndex[structuralKey]={
            Shortlist=shortlist, Spicy=spicyStageTwo, Regular=regularStageTwo,
            Obscure=obscureStageReturns
        }
    end

    -- If UsedWords filtered many representatives, refill cheaply from the current
    -- valid list without strategic analysis. Full analysis below stays bounded.
    if #shortlist<40 then
        local seen={}
        for _,w in ipairs(shortlist) do seen[w]=true end
        for _,w in ipairs(originalCandidateList) do
            if not seen[w] then
                shortlist[#shortlist+1]=w; seen[w]=true
                if #shortlist>=40 then break end
            end
        end
    end
    -- F8 only: inject the cached 2-10-answer obscure bank before expensive
    -- finalist analysis. Normal Pro keeps its original shortlist unchanged.
    if env.WordHelperUnbeatable.ProSpicyRandom and (stage==3 or stage==4) then
        local spicySeen={}
        for _,w in ipairs(shortlist) do spicySeen[w]=true end
        for _,w in ipairs(obscureStageReturns or {}) do
            if not spicySeen[w] then
                shortlist[#shortlist+1]=w
                spicySeen[w]=true
            end
        end
    ...
    local function better(a, b)
        ...
        -- V20.8.37 F8 SPICY: stage-aware anti-memorization strategy.
        -- Stage 2 keeps the confirmed Pro trap bank first. Stage 3/4 deliberately
        -- prefers obscure exact-stage returns with 2-10 TOTAL live answers, rather
        -- than repeatedly exposing the famous/easy-to-memorize 1-answer traps.
        if env.WordHelperUnbeatable.ProSpicyRandom then
            local spicyStage = math.clamp(tonumber(env.WordHelperUnbeatable.Stage) or 1,1,4)
            if spicyStage == 2 then
                local pa = infoA and infoA.Prefix or ""
                local pb = infoB and infoB.Prefix or ""
                local aPriority = #pa==2 and env.WordHelperUnbeatable.ProGodmodePriorityTwoLetterTraps[pa] == true
                local bPriority = #pb==2 and env.WordHelperUnbeatable.ProGodmodePriorityTwoLetterTraps[pb] == true
                if aPriority ~= bPriority then return aPriority end
                local aTrap = #pa==2 and env.WordHelperUnbeatable.ProGodmodeTwoLetterTraps[pa] == true
                local bTrap = #pb==2 and env.WordHelperUnbeatable.ProGodmodeTwoLetterTraps[pb] == true
                if aTrap ~= bTrap then return aTrap end
                local aFresh = pa ~= "" and not env.WordHelperUnbeatable.ProSpicyUsedPrefixes[pa]
                local bFresh = pb ~= "" and not env.WordHelperUnbeatable.ProSpicyUsedPrefixes[pb]
                if aFresh ~= bFresh then return aFresh end
            elseif spicyStage == 3 or spicyStage == 4 then
                local repliesA = infoA and infoA.NonSelfReplies or math.huge
                local repliesB = infoB and infoB.NonSelfReplies or math.huge
                local totalA = repliesA < math.huge and (repliesA + (infoA.SelfSolve == true and 1 or 0)) or math.huge
                local totalB = repliesB < math.huge and (repliesB + (infoB.SelfSolve == true and 1 or 0)) or math.huge
                local prefixA = infoA and infoA.Prefix or ""
                local prefixB = infoB and infoB.Prefix or ""
                local obscureA = #prefixA==spicyStage and totalA>=2 and totalA<=10
                local obscureB = #prefixB==spicyStage and totalB>=2 and totalB<=10
                if obscureA ~= obscureB then return obscureA end
                if obscureA and obscureB then
                    local aFresh = not env.WordHelperUnbeatable.ProSpicyUsedPrefixes[prefixA]
                    local bFresh = not env.WordHelperUnbeatable.ProSpicyUsedPrefixes[prefixB]
                    if aFresh ~= bFresh then return aFresh end
                    local scoreA=env.WordHelperUnbeatable.ProSpicyObscurityScore(prefixA)
                    local scoreB=env.WordHelperUnbeatable.ProSpicyObscurityScore(prefixB)
                    local bandA=math.floor(scoreA/4)
                    local bandB=math.floor(scoreB/4)
                    if bandA~=bandB then return bandA>bandB end
        ...
        -- V20.8.24 NORMAL PRO:
        -- Compare TOTAL live escapes first. A self-solve is still a real escape
        -- for the opponent, even though it requires no extra typing.
        local repliesA = infoA and infoA.NonSelfReplies or math.huge
        local repliesB = infoB and infoB.NonSelfReplies or math.huge
        local selfA = infoA and infoA.SelfSolve == true
        local selfB = infoB and infoB.SelfSolve == true
        local totalA = repliesA < math.huge and (repliesA + (selfA and 1 or 0)) or math.huge
        local totalB = repliesB < math.huge and (repliesB + (selfB and 1 or 0)) or math.huge
        if totalA ~= totalB then return totalA < totalB end

        -- At equal total response count, a prefix with NO self-solve wins.
        -- This prevents "just press Enter" from outranking a prefix that forces typing.
        if selfA ~= selfB then return not selfA end

        -- Normal Pro then prefers the return whose EASIEST forced response is
        -- longest/hardest to type. Existing GetProForcedReplyDifficulty supplies
        -- the forced-response difficulty metric and keeps the old fallbacks.
        if not env.WordHelperUnbeatable.ProSpicyRandom and totalA < math.huge then
            local hardLenA = difficultyFor(a, infoA)
            local hardLenB = difficultyFor(b, infoB)
            if hardLenA ~= hardLenB then return hardLenA > hardLenB end
        end
    ...
    -- Build the visible F9 categories in the SAME relative order as Godmode.
    -- LOWEST ENTRY is deliberately omitted; it is represented by the normal-Pro
    -- fallback inserted after all available categories.
    local categories = {}
    if env.WordHelperUnbeatable.ProSpamMode then
        for index, category in ipairs(Config.GodmodePriority or {}) do
            if category ~= "__LOWEST_ENTRY__" then
                if category == "__TRAP__" then
                    categories[#categories + 1] = {Index=index, Kind="TRAP", Value=category}
                elseif category == "__X__" then
                    categories[#categories + 1] = {Index=index, Kind="X", Value=category}
                elseif type(category) == "string" and category ~= "" then
                    -- V20.8.22: do NOT call GetProBaseReplyInfo here. That full-Pro
                    -- availability query was the remaining F9 hitch. The candidate
                    -- pool is already filtered against UsedWords/Blacklist, so an
                    -- ending is live iff this refresh actually finds a candidate.
                    categories[#categories + 1] = {Index=index, Kind="ENDING", Value=category}
                end
            end
        end
    end

    -- V20.8.23: pre-index literal endings so F9 does NOT loop through every
    -- priority category for every candidate. On broad prefixes such as "s",
    -- that old candidates x categories loop was the remaining spam-only hitch.
    local endingCategoryIndex = {}
    local endingLengths = {}
    local endingLengthSeen = {}
    local trapCategoryIndex = nil
    local xCategoryIndex = nil
    if env.WordHelperUnbeatable.ProSpamMode then
        for ci, cat in ipairs(categories) do
            if cat.Kind == "TRAP" then
                trapCategoryIndex = ci
            elseif cat.Kind == "X" then
                xCategoryIndex = ci
            elseif cat.Kind == "ENDING" then
                endingCategoryIndex[cat.Value] = ci
                local n = #cat.Value
                if not endingLengthSeen[n] then
                    endingLengthSeen[n] = true
                    endingLengths[#endingLengths + 1] = n
                end
            end
        end
    end
    ...
    local spamCacheKey = ""
    if env.WordHelperUnbeatable.ProSpamMode then
        local first = candidateList[1] or ""
        local last = candidateList[#candidateList] or ""
        spamCacheKey = table.concat({
            tostring(#candidateList), first, last,
            "s" .. tostring(env.WordHelperUnbeatable.Stage or 1),
            tostring(env.WordHelperUsedTracker and env.WordHelperUsedTracker.LastRecordedWord or ""),
            table.concat(Config.GodmodePriority or {}, "|")
        }, "\31")
        if env.WordHelperUnbeatable.ProSpamChoiceCacheKey == spamCacheKey then
            for k, v in pairs(env.WordHelperUnbeatable.ProSpamChoiceCache or {}) do
                categoryBest[k] = v
            end
        end
    end

    local needSpamScan = env.WordHelperUnbeatable.ProSpamMode and next(categoryBest) == nil

    for _, w in ipairs(candidateList) do
        local info = env.WordHelperUnbeatable.GetProCandidateInfo(w)
        infoMap[w] = info

        -- Keep normal Pro top-K at the same time. This becomes LOWEST ENTRY's
        -- final fallback and fills any remaining rows after diversified choices.
        ...
        if needSpamScan then
            -- Preserve "highest Godmode category wins", but use direct lookups.
            local matchedIndex = nil
            if trapCategoryIndex and GodmodeIsTrapWord(w) then
                matchedIndex = trapCategoryIndex
            end

            if xCategoryIndex and w:sub(-1) == "x"
                and (matchedIndex == nil or xCategoryIndex < matchedIndex) then
                matchedIndex = xCategoryIndex
            end

            for _, endingLen in ipairs(endingLengths) do
                if #w >= endingLen then
                    local ci = endingCategoryIndex[w:sub(-endingLen)]
                    if ci and (matchedIndex == nil or ci < matchedIndex) then
                        matchedIndex = ci
                    end
                end
            end
            ...
            if matchedIndex then
                local cat = categories[matchedIndex]
                local current = categoryBest[matchedIndex]
                if current == nil then
                    categoryBest[matchedIndex] = w
                elseif cat.Kind == "ENDING" then
                    -- V20.8.26 FAST F9:
                    -- Literal spam is a display representative, so choose shortest
                    -- then lexical without invoking the expensive Pro comparator.
                    if #w < #current or (#w == #current and w < current) then
                        categoryBest[matchedIndex] = w
                    end
                else
                    -- TRAP/X representatives also stay cheap during the broad scan.
                    -- Prefer the shortest representative, lexical on ties. The normal
                    -- Pro heap below still performs the full strategic analysis for
                    -- LOWEST ENTRY/fallback choices exactly as before.
                    if #w < #current or (#w == #current and w < current) then
                        categoryBest[matchedIndex] = w
                    end
                end
    ...
    if needSpamScan then
        env.WordHelperUnbeatable.ProSpamChoiceCache = {}
        for k, v in pairs(categoryBest) do
            env.WordHelperUnbeatable.ProSpamChoiceCache[k] = v
        end
        env.WordHelperUnbeatable.ProSpamChoiceCacheKey = spamCacheKey
        env.WordHelperUnbeatable.ProSpamChoiceCacheAt = tick()
    end

    table.sort(heap, better)

    if not env.WordHelperUnbeatable.ProSpamMode then
        -- Stage-2 trap priority: confirmed Pro traps are surfaced ahead of the
        -- ordinary heap, with the requested Pro-only spicy set first.
        if stage == 2 then
            local merged, mergedSeen = {}, {}
            local function mergeWord(w)
                if w and not mergedSeen[w] then
                    mergedSeen[w] = true
                    merged[#merged + 1] = w
                end
            end
            for _, w in ipairs(spicyStageTwo) do mergeWord(w) end
            for _, w in ipairs(regularStageTwo) do mergeWord(w) end
            for _, w in ipairs(heap) do mergeWord(w) end
            heap = merged
        end

        -- Safety fill only; no expensive analysis is performed here.
        if #heap < 40 then
            local present = {}
            for _, w in ipairs(heap) do present[w] = true end
            for _, w in ipairs(originalCandidateList) do
                if not present[w] then
                    heap[#heap + 1] = w
                    present[w] = true
                    if #heap >= 40 then break end
                end
            end
        end
        return heap
    ...
    -- Diversified front page:
    --   literal spam = shortest available representative;
    --   TRAP/X = strongest Pro representative;
    --   then normal Pro lowest-response fallback.
    -- Then append the remaining normal-Pro top choices so the list never feels empty.
    local result, seen = {}, {}
    for ci = 1, #categories do
        local w = categoryBest[ci]
    ...
    -- LOWEST ENTRY is ALWAYS the final strategic fallback, regardless of where
    -- it is positioned in the shared Godmode editor.
    for _, w in ipairs(heap) do
        if not seen[w] then
            result[#result + 1] = w
            seen[w] = true
            break
    ...
    -- Fill remaining display capacity with ordinary Pro choices after the
    -- diversified representatives; never flood ahead of the fallback choices.
    for _, w in ipairs(heap) do
        if not seen[w] then
            result[#result + 1] = w
            seen[w] = true
            if #result >= keepLimit then break end
        end
    end
...
UpdateList = function(detectedText, requiredLetter)
    ...
    if sortMode == "Godmode" then
        -- V20.8.25.2 SAFE DISPLAY-ONLY LAYER.
        -- `matches`, CollectMatches, GodmodeGetPriorityCategory and GetGodmodeScore
        -- remain exactly V20.8.24. We only choose which already-valid words occupy
        -- the first 40 visible rows.
        env.WordHelperGodmodeDisplay = env.WordHelperGodmodeDisplay or {}
        local gd = env.WordHelperGodmodeDisplay
        if env.WordHelperUnbeatable and env.WordHelperUnbeatable.SyncStageFromUsedWords then
            env.WordHelperUnbeatable.SyncStageFromUsedWords()
        end
        gd.Stage = math.clamp(
            tonumber(env.WordHelperUnbeatable and env.WordHelperUnbeatable.Stage) or 1,
            1, 4
        )
        gd.Selected = {}
        gd.Represented = {}
        gd.Ordinary = {}
        gd.StageTwoTrapEndings = {}
        gd.PrimaryTrapCandidates = {}

        local function addDisplay(word)
            if word and not gd.Selected[word] and #displayList < maxDisplay then
                table.insert(displayList, word)
                gd.Selected[word] = true
                return true
            end
            return false
        end

        -- V20.9.4 TEMP: recovered Casual test words occupy the very top rows first.
        -- Show as many matching test words as are available before normal priorities.
        ...
        -- One representative for each configured priority that is actually
        -- available at the current stage. This classification is local to the
        -- display and cannot hide/remove candidates from WordHelper.
        for priorityIndex, category in ipairs(Config.GodmodePriority) do
            local allowed = category == "__X__" or category == "__LOWEST_ENTRY__"
            if category == "__TRAP__" then
                allowed = gd.Stage >= 2
            elseif category ~= "__X__" and category ~= "__LOWEST_ENTRY__" then
                allowed = type(category) == "string" and #category <= gd.Stage
            end
            ...
            if allowed then
                for _, word in ipairs(matches) do
                    ...
                    if category == "__TRAP__" then
                        if gd.Stage == 2 then
                            -- Random starting point means the primary TRAP row is
                            -- not predictably the same confirmed ending each refresh.
                            gd.PrimaryTrapCandidates = gd.PrimaryTrapCandidates or {}
                            if #gd.PrimaryTrapCandidates == 0 then
                                for _, trapWord in ipairs(matches) do
                                    if #trapWord >= 2
                                        and GodmodeConfirmedTwoLetter[trapWord:sub(-2)] == true then
                                        table.insert(gd.PrimaryTrapCandidates, trapWord)
                                    end
                                end
                                for ti = #gd.PrimaryTrapCandidates, 2, -1 do
                                    local tj = math.random(ti)
                                    gd.PrimaryTrapCandidates[ti], gd.PrimaryTrapCandidates[tj] =
                                        gd.PrimaryTrapCandidates[tj], gd.PrimaryTrapCandidates[ti]
                                end
                            end
                            qualifies = gd.PrimaryTrapCandidates[1] == word
                        else
                            qualifies = GodmodeIsTrapWord(word)
                        end
                    elseif category == "__LOWEST_ENTRY__" then
                        qualifies = GodmodeLowestEntryActiveSet[word] == true
                    elseif category == "__X__" then
                        qualifies = word:sub(-1) == "x"
                    else
                        qualifies = #word >= #category
                            and word:sub(-#category) == category
                            and GodmodeHasAvailableReply(category)
                    end
        ...
        -- Stage 2: after the main TRAP representative, expose several DIFFERENT
        -- confirmed trap endings so SD/MG/RG/etc. are genuinely useful early-game.
        if gd.Stage == 2 then
            -- Gather one valid word for every different confirmed 2-letter trap
            -- ending, then shuffle those representatives before displaying them.
            -- This changes variety only; it never changes candidate validity/scoring.
            gd.StageTwoTrapPool = {}
            for _, word in ipairs(matches) do
                local ending = #word >= 2 and word:sub(-2) or ""
                if GodmodeConfirmedTwoLetter[ending]
                    and not gd.StageTwoTrapEndings[ending] then
                    gd.StageTwoTrapEndings[ending] = true
                    table.insert(gd.StageTwoTrapPool, word)
                end
            end
            for i = #gd.StageTwoTrapPool, 2, -1 do
                local j = math.random(i)
                gd.StageTwoTrapPool[i], gd.StageTwoTrapPool[j] =
                    gd.StageTwoTrapPool[j], gd.StageTwoTrapPool[i]
            end
            for _, word in ipairs(gd.StageTwoTrapPool) do
                addDisplay(word)
                if #displayList >= 12 then break end
            end
        end

        -- Build the user's small "be unique" section from ordinary candidates.
        -- These are words which do not match ANY strategic Godmode priority.
        for _, word in ipairs(matches) do
            local _, categoryIndex = GodmodeGetPriorityCategory(word)
            if not categoryIndex then
                table.insert(gd.Ordinary, word)
            end
        end
        table.sort(gd.Ordinary, function(x, y)
            if #x == #y then return x < y end
            return #x < #y
        end)

        local shortPool = math.min(12, #gd.Ordinary)
        for i = shortPool, 2, -1 do
            local j = math.random(i)
            gd.Ordinary[i], gd.Ordinary[j] = gd.Ordinary[j], gd.Ordinary[i]
        end
        for i = 1, math.min(6, shortPool) do
            addDisplay(gd.Ordinary[i])
        end

        -- Absolute safety fallback: fill every remaining row directly from the
        -- untouched V20.8.24 `matches` array. Nothing can disappear because of
        -- the stage-aware display layer.
        for _, word in ipairs(matches) do
        ...
        if w then
            ...
            if not btn then
                ...
                btn.MouseEnter:Connect(function()
                    ...
                    if not (d and d.used) then Tween(btn, {BackgroundColor3 = Color3.fromRGB(13,35,20)}) end
                end)
                btn.MouseLeave:Connect(function()
                    local d = ButtonData[btn]
                    Tween(btn, {BackgroundColor3 = (d and d.used) and Color3.fromRGB(5,12,8) or THEME.ItemBG})
                end)
                ...
                btn.MouseButton1Click:Connect(function()
                    ...
                    if d and not d.used then
                        ...
                        Tween(btn, {BackgroundColor3 = Color3.fromRGB(10,48,23)})
                    end
                end)
            ...
            -- V20.9.2 LIVE TYPING PROGRESS
            local progressLen = 0
            if isBacktracked then
                if w:sub(1, #searchPrefix) == searchPrefix then progressLen = #searchPrefix end
            elseif detectedText ~= "" and w:sub(1, #detectedText) == detectedText then
                progressLen = #detectedText
            end
            local typedPart = w:sub(1, progressLen)
            local remainingPart = w:sub(progressLen + 1)
            local displayText
            if progressLen > 0 then
                displayText = "<font color=\"rgb(45,255,112)\">" .. typedPart .. "</font>"
                    .. "<font color=\"rgb(" .. textRGB .. ")\">" .. remainingPart .. "</font>"
            else
                displayText = "<font color=\"rgb(" .. textRGB .. ")\">" .. w .. "</font>"
            end
            
            -- Show why a word is prioritized while GodMode is selected.
            if sortMode == "Godmode" then
                local categoryTag, _, _, lowestInfo = GodmodeGetPriorityCategory(w)
                local casualStage = math.clamp(
                    tonumber(env.WordHelperGodmodeDisplay and env.WordHelperGodmodeDisplay.Stage) or 1,
                    1, 4
                )

                if categoryTag == "LOWEST ENTRY" and lowestInfo then
                    displayText = displayText
                        .. "  <font color=\"rgb(150,150,160)\">[S"
                        .. tostring(casualStage)
                        .. " / LOWEST ENTRY -> <font color=\"rgb(45,255,112)\"><b>"
            ...
            elseif sortMode == "Unbeatable" then
                ...
                local prefixDisplay = ub.Prefix ~= ""
                    and ("<font color=\"rgb(45,255,112)\"><b>" .. prefixTag .. "</b></font>")
                    or prefixTag
            ...
            elseif sortMode == "Pro Unbeatable" then
                ...
                if env.WordHelperUnbeatable.ProSpicyRandom and pro.Prefix and pro.Prefix ~= "" then
                    env.WordHelperUnbeatable.ProSpicyRecentWordPrefix[w] = pro.Prefix
                end
                local prefixTag = pro.Prefix ~= "" and pro.Prefix:upper() or "FALLBACK"
                local prefixDisplay = pro.Prefix ~= ""
                    and ("<font color=\"rgb(45,255,112)\"><b>" .. prefixTag .. "</b></font>")
                    or prefixTag
...
-- V20.8.7 SERVER-ONLY USED-WORD TRACKING
-- Accepted words are now sourced exclusively from the server-confirmed packet path.
-- CurrentWord remains available elsewhere for prefix/stage/UI functions, but it no
-- longer has authority to add anything to UsedWords.

env.WordHelperUsedTracker.IsKnownDictionaryWord = function(word)
    -- V20.8.15: preserve apostrophes/hyphens. %c is NOT appropriate here because
    -- punctuation is part of the canonical identity of many Pro words.
    word = tostring(word or ""):lower():gsub("%s+", "")
    if #word < 2 then return false end
...
env.WordHelperUsedTracker.NormalizedUsed = env.WordHelperUsedTracker.NormalizedUsed or {}

env.WordHelperUsedTracker.RecordObservedUsedWord = function(word, serverConfirmed)
    -- V20.8.7: only the authoritative Packet 26 -> AnswerResults path may mark USED.
    if serverConfirmed ~= true then return end
    -- Preserve punctuation exactly from the authoritative server answer.
    word = tostring(word or ""):lower():gsub("%s+", "")
    if #word < 2 then return end

    local storedWord = word

    -- V20.8.14: resolve a server-confirmed word against the full Pro dictionary
    -- BEFORE the known-word gate, including punctuation-normalized Pro entries.
    if sortMode == "Pro Unbeatable"
        and env.WordHelperUnbeatable
        and env.WordHelperUnbeatable.ProDictionaryNormalizedUnique then
    ...
    env.WordHelperUsedTracker.NormalizedUsed[storedWord:gsub("[^a-z]", "")] = true
    if env.WordHelperUnbeatable
        and env.WordHelperUnbeatable.ProSpicyRandom
        and env.WordHelperUnbeatable.ProSpicyRecentWordPrefix then
        local spicyPrefix = env.WordHelperUnbeatable.ProSpicyRecentWordPrefix[storedWord]
        if spicyPrefix and spicyPrefix ~= "" then
            env.WordHelperUnbeatable.ProSpicyUsedPrefixes[spicyPrefix] = true
        end
    end
    env.WordHelperUsedTracker.LastRecordedWord = storedWord
    env.WordHelperUsedTracker.LastRecordedSource =
        "Server AnswerResults"
    env.WordHelperUsedTracker.LastRecordedAt = tick()
    -- The authoritative accepted-word signal ends any long-word display pin.
    if env.WordHelperLongWord then
        env.WordHelperLongWord.Reset()
    end
    ...
    -- Pro ranking caches must never survive a newly accepted/used word.
    if env.WordHelperUnbeatable then
        env.WordHelperUnbeatable.ProForcedReplyCache = {}
        env.WordHelperUnbeatable.SortCache = {}
    end
...
env.WordHelperUsedTracker.ClearUsedWords = function(showNotification)
    ...
    if env.WordHelperUsedTracker.NormalizedUsed then
        table.clear(env.WordHelperUsedTracker.NormalizedUsed)
    end
    if env.WordHelperLongWord then env.WordHelperLongWord.Reset() end
    if env.WordHelperUnbeatable then
        env.WordHelperUnbeatable.ProSpicyUsedPrefixes = {}
        env.WordHelperUnbeatable.ProSpicyRecentWordPrefix = {}
    end
...
runConn = RunService.RenderStepped:Connect(function()
    local success, err = pcall(function()
        ...
        -- V20.8.11: Last Letter uses a literal "..." overflow tile for long words.
        -- Preserve the previous full prefix before reading the new sliding window.
        env.WordHelperLongWord.PreviousDetected = cachedDetected or ""
        cachedDetected, cachedCensored = GetCurrentGameWord(frame)

        if not cachedCensored and env.WordHelperLongWord then
            if env.WordHelperLongWord.ReconstructSliding then
                cachedDetected = env.WordHelperLongWord.ReconstructSliding(
                    env.WordHelperLongWord.PreviousDetected,
                    cachedDetected
                )
            end
            if env.WordHelperLongWord.Resolve then
                cachedDetected = env.WordHelperLongWord.Resolve(
                    cachedDetected,
                    requiredLetter
                )
            end
        ...
        -- V20.8.7: no CurrentWord/Type-transition UsedWords fallback.
        -- Only server-confirmed AnswerResults packets can mark an accepted word USED.
        ...
        elseif detected ~= lastDetected or requiredLetter ~= lastRequiredLetter or forceUpdateList then
            ...
            if detected == "" and not forceUpdateList then
                ...
                -- V20.8.38: Pro ranking can be expensive on a fresh turn. Do not run
                -- the full candidate analysis inside the same RenderStepped callback
                -- that observes the turn change; let one short debounce window pass so
                -- the game/UI transition renders first. Other modes keep instant refresh.
                if sortMode == "Pro Unbeatable" then
...
inputConn = UserInputService.InputBegan:Connect(function(input)
    ...
    if input.KeyCode == Enum.KeyCode.F9 then
        if sortMode ~= "Pro Unbeatable" then
            if ShowToast then
                ShowToast("Pro Spam Mode only works in Pro Unbeatable", "warning")
            end
            if StatusText then
                StatusText.Text = "F9 Spam: Pro Unbeatable only"
                StatusText.TextColor3 = THEME.Warning
            end
            return
        end

        env.WordHelperUnbeatable.ProSpamMode =
            not env.WordHelperUnbeatable.ProSpamMode
        env.WordHelperUnbeatable.ProSortCache = {}
        env.WordHelperUnbeatable.ProForcedReplyCache = {}
        env.WordHelperUnbeatable.ProSpamChoiceCache = {}
        env.WordHelperUnbeatable.ProSpamChoiceCacheKey = ""
        currentBestMatch = nil
        forceUpdateList = true
        lastDetected = "---"
        ...
        if ShowToast then
            ShowToast(
                env.WordHelperUnbeatable.ProSpamMode
                    and "Pro Spam: ON / LOWEST ENTRY = final fallback"
                    or "Pro Spam Mode: OFF (F9)",
                env.WordHelperUnbeatable.ProSpamMode and "success" or "warning"
            )
        end
        if StatusText then
            StatusText.Text = env.WordHelperUnbeatable.ProSpamMode
                and "Pro Spam: ON / one choice per ending -> Pro fallback"
                or "Pro Spam Mode: OFF (F9)"
            StatusText.TextColor3 = env.WordHelperUnbeatable.ProSpamMode
        ...
        if ShowToast then
            ShowToast(
                env.WordHelperUnbeatable.ProSpicyRandom
                    and "Pro Spicy: ON / S2 traps + S3/S4 obscure 2-10"
