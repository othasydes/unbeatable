...
env.WordHelperDiscovery.ObserveFrame = function(detectedWord, censored, typeText, now, frame)
    ...
    elseif typeText ~= env.WordHelperDiscovery.LastTypeText then
        ...
        local candidate = tostring(env.WordHelperDiscovery.CurrentCandidate or "")
        local candidateAt = tonumber(env.WordHelperDiscovery.CurrentCandidateAt or 0) or 0
        ...
        if pulseAt > 0
            ...
            and (not env.WordHelperDiscovery.CandidateTruncated
                or env.WordHelperDiscovery.ReconstructionValid == true) then
            env.WordHelperDiscovery.ConsiderAccepted(candidate, "WPM + turn change")
        end
