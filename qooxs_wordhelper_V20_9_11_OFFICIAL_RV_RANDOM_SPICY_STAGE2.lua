...
-- V20.9.11 OFFICIAL: RV confirmed + equal/random Pro Spicy Stage-2 traps
...
Title.Text = "<font color=\"rgb(45,255,112)\">qoox\'s</font> wordhelper <font color=\"rgb(105,166,121)\">// V20.9.11</font>"
Title.RichText = true
...
env.WordHelperUnbeatable.ProGodmodeTwoLetterTraps = {
    ...
    mv=true, vp=true, rz=true, pm=true, xw=true, rw=true, rv=true
}
...
env.WordHelperUnbeatable.SelectTopProCandidates = function(candidateList)
    ...
    if reverse then
        ...
        if stage==2 then
            -- V20.9.11 F8: every confirmed 2-letter trap is one equal pool.
            for _,row in ipairs(discovered) do
                local p=row.Prefix
                if #p==2 and env.WordHelperUnbeatable.ProGodmodeTwoLetterTraps[p]
                    and not spicySeen[p] then
                    spicySeen[p]=true
                    spicyStageTwo[#spicyStageTwo+1]=row.Word
                end
            end
            for i=#spicyStageTwo,2,-1 do
                local j=math.random(i)
                spicyStageTwo[i],spicyStageTwo[j]=spicyStageTwo[j],spicyStageTwo[i]
            end
    ...
    local function better(a, b)
        ...
        if env.WordHelperUnbeatable.ProSpicyRandom then
            ...
            if spicyStage == 2 then
                ...
                -- V20.9.11 F8: no XW/RW/legacy priority inside confirmed traps.
