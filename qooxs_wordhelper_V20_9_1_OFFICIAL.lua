...
Title.Text = "<font color=\"rgb(45,255,112)\">qoox\'s</font> wordhelper <font color=\"rgb(105,166,121)\">// V20.9.1</font>"
Title.RichText = true
...
UpdateList = function(detectedText, requiredLetter)
    ...
    for i = 1, math.max(#displayList, #ButtonCache) do
        ...
        if w then
            ...
            local displayText = "<font color=\"rgb(" .. textRGB .. ")\">" .. w .. "</font>"
            
            -- V20.9.1: keep the typed word visually untouched.
            -- The predicted returned prefix is highlighted only inside the strategy tag.
