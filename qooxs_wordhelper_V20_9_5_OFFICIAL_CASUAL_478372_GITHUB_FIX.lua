...
-- V20.9.5: catch a broken/partial Casual dictionary instead of silently launching.
local expectedCasualWordCount = 478372
if #Words < expectedCasualWordCount then
    UpdateStatus(
        "CASUAL DICTIONARY ERROR: " .. tostring(#Words) .. " / "
        .. tostring(expectedCasualWordCount) .. " words loaded",
        THEME.Warning
    )
    error(
        "WordHelper V20.9.5 Casual dictionary incomplete: "
        .. tostring(#Words) .. "/" .. tostring(expectedCasualWordCount)
    )
end
UpdateStatus(
    "CASUAL VERIFIED: " .. tostring(#Words) .. " / "
    .. tostring(expectedCasualWordCount) .. " words loaded!",
    THEME.Success
)
...
Title.Text = "<font color=\"rgb(45,255,112)\">qoox\'s</font> wordhelper <font color=\"rgb(105,166,121)\">// V20.9.5</font>"
Title.RichText = true
